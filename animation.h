...
private:
    ...
    Point pos, posMax; // Instantaneous position of the local coordinate system origin
...
public:
    ...
    Vector getFn() const { return Fn; }
    Point getPosMax() const { return posMax; }
    void setPosMax(Point pt) { posMax = pt; }
};
